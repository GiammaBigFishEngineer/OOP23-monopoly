...
public class PlayerPanelView extends JPanel {
    ...
    public PlayerPanelView() {
        ...
        final TitledBorder border = new TitledBorder(BorderFactory.createLineBorder(Color.BLACK), TITLE, 0, 0,
                titleFont, Color.RED);
        ...
        properties.addAll(Arrays.asList("Name: ", "Id", "Money", "Houses on the current box: ", "Owned boxes: ",
                "Owned stations: "));
