 ...
 */
public class TestBankAccountImpl {
    private static final int DEFAULT_PAYMENT = 100;
    private static final int DEFAULT_ID = 1; 

    private PlayerImpl player1, player2;
    /**
    ...
    @Test 
    void testPayPlayer() {
        int expectedPlayerPayed = this.player2.getBankAccount().getBalance() - DEFAULT_PAYMENT;
    ...
    void testReceivePayment() {
        int expected = 3 * DEFAULT_PAYMENT; 
    ...
    */ 
    ...
    void testIsPaymentAllowed() {
        int amountToSpend = 10 * DEFAULT_PAYMENT; 
        boolean actualFirstResult = this.player1.getBankAccount().isPaymentAllowed(amountToSpend);
        Assertions.assertFalse(actualFirstResult);
        this.player1.getBankAccount().receivePayment(amountToSpend);
        boolean actualSecondResult = this.player1.getBankAccount().isPaymentAllowed(amountToSpend);
